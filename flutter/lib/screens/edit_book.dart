...
class EditBook extends StatelessWidget {
  ...
  EditBook({required this.book, required this.url});
  ...
  Future saveBook() async {
    final response = await http
        .put(Uri.parse(url +'/' + book['id'].toString()), body: {
        ...
        child: Form(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                TextFormField(
                  controller: _titleController..text = book['title'],
                ...
                TextFormField(
                  controller: _authorController..text = book['author'],
                  style: TextStyle(fontSize: 20),
                  decoration: InputDecoration(
                      contentPadding: EdgeInsets.only(top: 12),
                      labelText: 'Author'),
                ...
                TextFormField(
                  controller: _publicationController..text = book['publication'],
                  style: TextStyle(fontSize: 20),
                  decoration: InputDecoration(
                      contentPadding: EdgeInsets.only(top: 12),
                ...
                TextFormField(
                  controller: _yearController..text = book['year'],
                  style: TextStyle(fontSize: 20),
                  decoration: InputDecoration(
                      contentPadding: EdgeInsets.only(top: 12),
                      labelText: 'Year'),
